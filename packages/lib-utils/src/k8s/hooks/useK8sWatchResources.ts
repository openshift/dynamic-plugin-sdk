...
import { UseK8sWatchResources, WatchK8sResources } from './watch-resource-types';
import {
...
export const useK8sWatchResources: UseK8sWatchResources = (initResources) => {
  ...
  const allK8sModels = useSelector<OpenShiftReduxRootState, ImmutableMap<string, K8sModelCommon>>(
