...
export interface ObjectMetadata {
   ...
   *
   * @deprecated selfLink is no longer populated by the system.
   */
  selfLink?: string;
  /**
...
export type RequiredK8sResourceCommon<T extends keyof K8sResourceCommon> = K8sResourceCommon &
  Required<Pick<K8sResourceCommon, T>>;
